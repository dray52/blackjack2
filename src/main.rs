...
async fn main() {
   ...
   reset.with_border(RED, 5.0);
    ...
    let mut pcard5 = ImageObject::new(show, 75.0, 150.0, 345.0, 200.0).await;
    let mut pcard4 = ImageObject::new(show, 75.0, 150.0, 290.0, 200.0).await;
    let mut pcard3 = ImageObject::new(show, 75.0, 150.0, 235.0, 200.0).await;
    let mut pcard2 = ImageObject::new(show, 75.0, 150.0, 180.0, 200.0).await;
    let mut pcard1 = ImageObject::new(show, 75.0, 150.0, 125.0, 200.0).await;
    let mut dcard1 = ImageObject::new(show, 75.0, 150.0, 125.0, 25.0).await;
    let mut dcard2 = ImageObject::new(show, 75.0, 150.0, 180.0, 25.0).await;
    let mut dcard3 = ImageObject::new(show, 75.0, 150.0, 235.0, 25.0).await;
    let mut dcard4 = ImageObject::new(show, 75.0, 150.0, 290.0, 25.0).await;
    let mut dcard5 = ImageObject::new(show, 75.0, 150.0, 345.0, 25.0).await;
    let mut pvalue = 0;
    let mut dvalue = 0;
    let mut turn = 3;
    let mut dturn = 2;
